...
def compute_E_f_for_G(mdp, policy, init_s, T, policy_t):
    ...
    for t in range(T-policy_t-1):
        ...
        D = (mdp.T_matrix_transpose.dot(state_action_prob.reshape(init_s.shape[0],-1).T)).T
